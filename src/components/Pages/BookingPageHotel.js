        ...
        <div className="BookingPageHotel_Child_data">
          <div className="BookingPageHotel_Child_data_left">
            <div className="BookingPageHotel_Child_data_left_data1">
              ...
              >
                ...
                >
                  <span style={{marginLeft:"10px"}}>{HotelBookingData?.amenities?.[0]}  </span>
                  <span style={{marginLeft:"10px"}}>{HotelBookingData?.amenities?.[1]}</span>
                  <span style={{marginLeft:"10px"}}>{HotelBookingData?.amenities?.[2]}</span>
                </h3>
              </div>
            </div>
          ...
          <div className="BookingPageHotel_Child_data_right">
            <div>
              ...
              >
                <h2>Total Amount</h2>
                <h3>Rs {Math.floor(HotelBookingData.avgCostPerNight) + taxes}</h3>
              </div>
            </div>
            <button onClick={handlepaymentPage} className="HotelBooingpageBtn">Continue</button>
          </div>
        </div>
      </div>
    </div>
